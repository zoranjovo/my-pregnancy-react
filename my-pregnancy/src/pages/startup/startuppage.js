...
function StartupPage() {
  ...
  function directToSignup() {
    const email = emailRef1.current.value || emailRef2.current.value;
    if(!email || email === ''){
      navigate(`/signup`);
    } else {
      ...
      <div style={{ minHeight: 'calc(100vh - 202px)' }}>
        ...
        <div className={styles.section1}>
          ...
          <div className={styles.joinBox}>
            ...
            <input className={styles.emailInput} placeholder='Email' ref={emailRef1} onKeyPress={handleKeyPress}/>
        ...
        <div className={styles.section3}>
          <div className={styles.joinBox2}>
            <h1 className={styles.text2}>Join us today!</h1>
            <input className={styles.emailInput} placeholder='Email' ref={emailRef2} onKeyPress={handleKeyPress}/>
            <button className={`${buttons.stylisedBtn} ${styles.signupBtn}`} onClick={directToSignup}>Sign up</button>
          </div>
        </div>
      </div>
